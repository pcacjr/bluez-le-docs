...
-c or --capability option can be used to change the default(\"KeyboardDisplay\")
value. Other possible values are: \"DisplayOnly\", \"DisplayYesNo\",
\"KeyboardOnly\", \"NoInputNoOutput\"

After \"creating\" a new device, test-device script can be used to interact
